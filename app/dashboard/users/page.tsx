      ...
      <Card className="bg-card text-foreground border-border shadow-lg">
        <CardHeader>
          <div className="flex items-center justify-between gap-3">
            <div>
              <CardTitle className="text-2xl font-bold text-foreground">Gestión de Usuarios</CardTitle>
          ...
          <div className="relative mt-4">
            <Input
              ...
              className="w-full pl-10 bg-input border-border text-foreground placeholder:text-muted-foreground"
            />
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="bg-popover border-border text-popover-foreground">
                          ...
                          <DropdownMenuItem
                            ...
                            className="hover:bg-destructive focus:bg-destructive cursor-pointer text-destructive"
                          >
        ...
        <DialogContent className="bg-popover text-popover-foreground border-border">
          ...
          <form onSubmit={handleSubmitCreate(onSubmitCreate)} className="space-y-4">
            <div className="grid gap-2">
              ...
              />
              {errorsCreate.email && <p className="text-destructive text-sm">{errorsCreate.email.message}</p>}
            </div>
            <div className="grid gap-2">
              ...
              />
              {errorsCreate.full_name && <p className="text-destructive text-sm">{errorsCreate.full_name.message}</p>}
            </div>
            <div className="grid gap-2">
              ...
              />
              {errorsCreate.username && <p className="text-destructive text-sm">{errorsCreate.username.message}</p>}
            </div>
            <div className="grid gap-2">
              ...
              />
              {errorsCreate.password && <p className="text-destructive text-sm">{errorsCreate.password.message}</p>}
            </div>
          ...
          <form onSubmit={handleSubmitEdit(onSubmitEdit)} className="space-y-4">
            <div className="grid gap-2">
              ...
              <Input
                ...
                {...registerEdit("email")}
              />
              {errorsEdit.email && <p className="text-destructive text-sm">{errorsEdit.email.message}</p>}
            </div>
            <div className="grid gap-2">
              ...
              />
              {errorsEdit.full_name && <p className="text-destructive text-sm">{errorsEdit.full_name.message}</p>}
            </div>
            <div className="flex items-center gap-3">
            ...
            <DialogFooter className="gap-2">
              ...
              <Button type="submit" disabled={isEditing} className="bg-primary hover:bg-primary/90">
          ...
          {loadingPermissions ? (
            ...
            <div className="space-y-4 max-h-96 overflow-y-auto">
              {availableRoutes.map((route) => (
                <div key={route.path} className="flex items-center space-x-3 p-3 rounded-lg bg-muted/50">
                  <Checkbox
                    id={route.path}
                  ...
                  <div className="flex-1">
                    <Label htmlFor={route.path} className="text-foreground font-medium cursor-pointer">
                      {route.name}
                    </Label>
