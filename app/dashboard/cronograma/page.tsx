            ...
            <CardContent>
              <div className="space-y-3 mb-4 bg-white/50 p-3 rounded-lg border">
                <div className="flex justify-between text-sm">
                  <span className="font-medium text-foreground">Por cobrar hoy:</span>
                  <span className="font-bold text-lg text-blue-700">{formatCurrency(summary.total_due_today)}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="font-medium text-foreground">Cobrado hoy:</span>
        ...
        <div className="space-y-4">
          <Card className="border-red-200 bg-red-50">
            ...
            <CardContent>
              <div className="space-y-3 mb-4 bg-white/50 p-3 rounded-lg border">
                <div className="flex justify-between text-sm">
                  <span className="font-medium text-foreground">Total vencido:</span>
          ...
          <Card className="border-green-200 bg-green-50">
            ...
            <CardContent>
              <div className="space-y-3 mb-4 bg-white/50 p-3 rounded-lg border">
                ...
                <div className="flex justify-between text-sm">
                  <span className="font-medium text-foreground">Ya cobrado:</span>
                  <span className="font-bold text-lg text-green-700">
