  ...
  return (
    <form onSubmit={handleSubmit} className="grid gap-4 py-4">
      <div className="grid grid-cols-4 items-start gap-4">
        <Label htmlFor="client_id" className="text-right text-muted-foreground pt-2">
          Cliente
        </Label>
        <div className="col-span-3">
          ...
          {errors.client_id && <p className="text-destructive text-xs mt-1">{errors.client_id}</p>}
        </div>
      </div>

      <div className="grid grid-cols-4 items-start gap-4">
        <Label htmlFor="amount" className="text-right text-muted-foreground pt-2">
          Monto
        </Label>
        <div className="col-span-3">
          ...
          <p className="text-xs text-muted-foreground mt-1">Ejemplo: $15000.00 (sin puntos de miles)</p>
          {errors.amount && <p className="text-destructive text-xs mt-1">{errors.amount}</p>}
        </div>
      </div>

      <div className="grid grid-cols-4 items-start gap-4">
        <Label htmlFor="installments" className="text-right text-muted-foreground pt-2">
          Cuotas
        </Label>
        <div className="col-span-3">
          <Input
            ...
            required
          />
          {errors.installments && <p className="text-destructive text-xs mt-1">{errors.installments}</p>}
        </div>
      </div>

      <div className="grid grid-cols-4 items-start gap-4">
        <Label htmlFor="installment_amount" className="text-right text-muted-foreground pt-2">
          Monto de cuota
        </Label>
        <div className="col-span-3">
          <div className="relative">
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Ejemplo: $1875.00 - Monto que pagará el cliente por cada cuota
          </p>
          {errors.installment_amount && <p className="text-destructive text-xs mt-1">{errors.installment_amount}</p>}
        </div>
      </div>

      <div className="grid grid-cols-4 items-start gap-4">
        <Label htmlFor="loan_type" className="text-right text-muted-foreground pt-2">
          Tipo de préstamo
        </Label>
        <div className="col-span-3">
      ...
      <div className="grid grid-cols-4 items-start gap-4">
        <Label htmlFor="delivery_mode" className="text-right text-muted-foreground pt-2">
          Modo de entrega
        </Label>
        <div className="col-span-3">
      ...
      <div className="grid grid-cols-4 items-start gap-4">
        <Label htmlFor="start_date" className="text-right text-muted-foreground pt-2">
          Fecha Inicio
        </Label>
        <div className="col-span-3">
          <Input
      ...
      <div className="grid grid-cols-4 items-start gap-4">
        <Label htmlFor="observations" className="text-right text-muted-foreground pt-2">
          Observaciones
        </Label>
        <div className="col-span-3">
          <Textarea
          ...
          />
          <p className="text-xs text-muted-foreground mt-1">Campo opcional para notas adicionales</p>
        </div>
      </div>
