            ...
            <form onSubmit={handleSaveLoan} className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input
                  id="start_date"
                  type="date"
                  value={currentLoan.start_date ? currentLoan.start_date.split("T")[0] : ""} // Formato YYYY-MM-DD
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input
                  id="end_date"
                  type="date"
                  value={currentLoan.end_date ? currentLoan.end_date.split("T")[0] : ""} // Formato YYYY-MM-DD
