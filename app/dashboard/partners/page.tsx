...
import { MoreHorizontal, PlusCircle } from "lucide-react" // Importamos PlusCircle para el botón de añadir
...
export default function PartnersPage() {
  ...
  const [newPartner, setNewPartner] = useState(initialNewPartnerState) // Estado para el nuevo socio
      ...
      <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
        <DialogContent className="sm:max-w-[425px] bg-gray-800 text-gray-100 border border-gray-700 shadow-lg">
          ...
          <form onSubmit={handleCreatePartner} className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="new_name" className="text-right text-gray-300">
                Nombre
              </Label>
              <Input
                id="new_name"
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="new_capital" className="text-right text-gray-300">
                Capital
              </Label>
              <Input
                id="new_capital"
                ...
                onChange={(e) => setNewPartner({ ...newPartner, capital: Number.parseFloat(e.target.value) })}
                className="col-span-3 bg-gray-700 border-gray-600 text-gray-100 placeholder:text-gray-400"
                required
              />
            </div>
